...
WidgetLightPoint::WidgetLightPoint(QWidget *parent, Light *light)
    : QWidget(parent)
{
    m_light = static_cast<PointLight *>(light);

    m_labelLightType = new QLabel("Type: Point light");
...
void WidgetLightPoint::onLightColorChanged(glm::vec3 newColor)
{
...
void WidgetLightPoint::onLightIntensityChanged(double)
{
