...
{
public:
    virtual std::shared_ptr<Material> createMaterial(const std::string &name,
                                                     const std::string &filepath,
                                                     MaterialType type,
                                                     bool createDescriptors = true) = 0;
    virtual std::shared_ptr<Material> createMaterial(const std::string &name, MaterialType type, bool createDescriptors = true) = 0;
